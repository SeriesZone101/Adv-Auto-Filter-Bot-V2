    ...
    if len(results) == 0: # double check
        ...
        try:
            ...
            await bot.send_photo(
                ...
                photo="https://telegra.ph/file/0dfbff9f71126a725e37d.jpg",

                caption=f"👉 NB : <a href='https://t.me/Troll_Cinemas_Channel'> ഇവിടെ ക്ലിക്ക് ചെയ്ത് ഈ ചാനലിൽ ജോയിൻ ചെയ്തതിനു ശേഷം മാത്രം തായെ ഉള്ള ബട്ടൺ അമർത്തുക അല്ലെങ്കിൽ 🗃️ Error കാണിക്കും 🤭 </a>",
